...
NBC_Plots_AngleTuning(whiskers.angle,ephys,whiskingEpochs_m,'whisker',false,false);
...
NBC_Plots_SpikesWhisking(whiskers.angle,whiskers.velocity,whiskers.phase,whiskingEpochs_m,ephys.rasters(mostFrqUnits,:));
