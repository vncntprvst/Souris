function [spikeRasters_ms,rasterXInd_ms,rasterYInd_ms,samplingRate,...
    ...
    templates,templateIdx,stimType,stimTimes_ms,videoFile] = WhiskerTouch_GatherData
...
for ROInum= 1:size(whiskerStim_FrameIdx,2)
    ...
    stimFrameIdx=cellfun(@(x) x(1), {stimPeriods.PixelIdxList{1,cellfun(@numel,stimPeriods.PixelIdxList)>10}});
